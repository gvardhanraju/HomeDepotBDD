...
public class LogInFuntionality {
     ...
     * d. Return Type: void
     * e. Parameters: 
	 * 		- String data: Valid email test data
     */
	public void enterValidEmail(String inputData) {
		try {
			helper.waitForElementToBeVisible(LogInFuntionalityLocators.emailInputField, 10);
			helper.sendData(LogInFuntionalityLocators.emailInputField, inputData);
     ...
     * d. Return Type: void
     * e. Parameters: 
	 * 		- String data: Valid password test data
     */
	public void enterPassword(String inputData) {
		try {
			helper.waitForElementToBeVisible(LogInFuntionalityLocators.passwordInputField, 10);
			helper.sendData(LogInFuntionalityLocators.passwordInputField, inputData);
     ...
     * d. Return Type: void
     * e. Parameters: 
	 * 		- String data: Invalid email test data
     */
	public void enterInvalidEmail(String inputData) {
		try {
